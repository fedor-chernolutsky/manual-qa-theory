...
Также можно встретить иную интерпретацию:<br>
...
• Все виды тестирования производительности:<br>
 ◦ нагрузочное тестирование (Performance and Load Testing)<br>
 ◦ стрессовое тестирование (Stress Testing)<br>
 ◦ тестирование стабильности или надежности (Stability / Reliability Testing)<br>
 ◦ объемное тестирование (Volume Testing)<br>
...
Статическое тестирование отличается от динамического тем, что производится без запуска программного кода продукта. Тестирование осуществляется путем анализа программного кода (code review) или скомпилированного кода. Анализ может производиться как вручную, так и с помощью специальных инструментальных средств. Целью анализа является раннее выявление ошибок и потенциальных проблем в продукте. Также к статическому тестированию относится тестирование спецификации и прочей документации.<br>
 <br>
 <br>
<br>
...
<br>
1. Тестирование по требованию: Для такого тестирования не требуется никакой документации или особой процедуры. Поскольку такое тестирование направлено на выявление дефектов случайным образом, без какой-либо документации, дефекты больше не будут сопоставляться с контрольными примерами. Вы можете использовать такое тестирование для выборочной проверки любой части приложения.<br>
<br>
2. Исследовательское тестирование: Это вид тестирования программного обеспечения, направленный на оптимизацию и улучшение программного обеспечения всеми возможными способами. При таком тестировании тестировщик может выбрать любую подходящую методологию для проверки программного обеспечения. Это стратегия тестирования программного обеспечения без заранее составленного плана. При исследовательском тестировании разработчики программного обеспечения используют свои знания, умения и навыки для проверки разработанного ими программного обеспечения.
 <br>
